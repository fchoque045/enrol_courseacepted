...
namespace enrol_courseacepted\form;
use moodleform;
...
class edit extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('select', 'status', get_string('status', 'enrol_courseacepted'), array(
            ENROL_INSTANCE_ENABLED => get_string('yes'),
            ENROL_INSTANCE_DISABLED  => get_string('no')));
        $mform->setDefault('status', $plugin->get_config('status'));
        $mform->addHelpButton('status', 'status', 'enrol_courseacepted');
        
        $mform->addElement('select', 'customint6', get_string('newenrols', 'enrol_courseacepted'), array(
            1 => get_string('yes'),
            0 => get_string('no')
        ));
        $mform->setDefault('newenrols', $plugin->get_config('newenrols'));
        $mform->addHelpButton('customint6', 'newenrols', 'enrol_courseacepted');
        ...
        $mform->addHelpButton('customint1', 'requiredcourse', 'enrol_courseacepted');
        ...
        // $mform->addHelpButton('customtext2', 'customwelcomemessage', 'enrol_courseacepted');
